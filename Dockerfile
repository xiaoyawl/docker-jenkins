...
RUN yum install -y epel-release && \
    yum install -y git curl freetype fontconfig unzip which bash \
        rsync ansible vim tree bash-completion telnet mtr iproute tar && \
    yum clean all
...
ENV JENKINS_VERSION ${JENKINS_VERSION:-2.348}

# jenkins.war checksum, download will be validated using it
#ARG JENKINS_SHA=996dfd29d5f933546af9e9f77c29b371fb0627b8266b6c9f134ac2e0f1248b87 2.289.3
